...
class ExerciseRepository {
  ...
  static const Map<String, List<int>> _repAnchorsMale = {
    ...
    'l-sit': [5, 10, 20, 30, 45],
    'dead-hang': [20, 40, 75, 120, 180],
    'hollow-hold': [15, 30, 60, 100, 150],
    // Calisthenic / accessory rep-count movements (catalog v3).
    'incline-push-up': [15, 30, 55, 80, 110],
    'deficit-push-up': [8, 16, 32, 50, 75],
    'assisted-dip': [5, 12, 25, 40, 60],
    'neutral-grip-pull-up': [1, 6, 13, 21, 31],
    'wide-grip-pull-up': [1, 4, 10, 17, 26],
    'assisted-pull-up': [5, 10, 18, 28, 40],
    'trx-row': [8, 16, 28, 42, 60],
    'trx-push-up': [8, 16, 30, 48, 70],
    'trx-biceps-curl': [8, 16, 28, 42, 60],
    'trx-triceps-extension': [8, 16, 28, 42, 60],
    'bench-dip': [12, 25, 45, 70, 100],
    'back-extension-45': [15, 30, 50, 75, 110],
    'reverse-hyperextension': [15, 30, 50, 75, 110],
    'bird-dog': [10, 20, 35, 55, 80],
    'dead-bug': [10, 20, 35, 55, 80],
    'reverse-lunge': [15, 30, 50, 75, 110],
    'lateral-lunge': [12, 24, 42, 65, 95],
    'curtsy-lunge': [12, 24, 42, 65, 95],
    'sissy-squat': [5, 12, 22, 35, 55],
    'assisted-pistol-squat': [3, 8, 15, 25, 40],
    'glute-ham-raise': [3, 8, 15, 25, 38],
    'stability-ball-leg-curl': [8, 16, 28, 42, 60],
    'single-leg-hip-thrust': [15, 28, 45, 65, 95],
    'single-leg-glute-bridge': [18, 32, 52, 75, 110],
    'frog-pump': [20, 38, 60, 90, 130],
    'donkey-kick': [15, 30, 50, 75, 110],
    'fire-hydrant': [15, 30, 50, 75, 110],
    'clamshell': [18, 35, 55, 85, 120],
    'single-leg-calf-raise': [15, 28, 45, 65, 95],
    'tibialis-raise': [15, 30, 50, 75, 110],
    'reverse-crunch': [15, 28, 45, 65, 95],
    'decline-crunch': [15, 28, 45, 65, 95],
    'decline-sit-up': [15, 28, 45, 65, 90],
    'v-up': [10, 20, 35, 52, 75],
    'lying-leg-raise': [10, 20, 35, 52, 75],
    'ab-wheel-rollout': [3, 8, 16, 28, 45],
  };
  ...
  static const Map<String, List<int>> _repAnchorsFemale = {
    ...
    'l-sit': [3, 7, 15, 24, 38],
    'dead-hang': [15, 30, 60, 100, 150],
    'hollow-hold': [12, 25, 50, 85, 130],
    // Calisthenic / accessory rep-count movements (catalog v3).
    'incline-push-up': [10, 20, 40, 60, 85],
    'deficit-push-up': [4, 10, 22, 38, 58],
    'assisted-dip': [4, 10, 20, 35, 55],
    'neutral-grip-pull-up': [1, 2, 5, 11, 17],
    'wide-grip-pull-up': [1, 1, 4, 8, 14],
    'assisted-pull-up': [3, 8, 15, 24, 36],
    'trx-row': [5, 12, 22, 34, 50],
    'trx-push-up': [4, 10, 22, 38, 56],
    'trx-biceps-curl': [5, 12, 22, 34, 50],
    'trx-triceps-extension': [5, 12, 22, 34, 50],
    'bench-dip': [8, 18, 35, 55, 80],
    'back-extension-45': [15, 30, 50, 75, 110],
    'reverse-hyperextension': [15, 30, 50, 75, 110],
    'bird-dog': [10, 20, 35, 55, 80],
    'dead-bug': [10, 20, 35, 55, 80],
    'reverse-lunge': [12, 25, 42, 65, 95],
    'lateral-lunge': [10, 20, 36, 56, 84],
    'curtsy-lunge': [10, 20, 36, 56, 84],
    'sissy-squat': [3, 8, 16, 28, 45],
    'assisted-pistol-squat': [2, 6, 12, 20, 34],
    'glute-ham-raise': [1, 4, 9, 16, 26],
    'stability-ball-leg-curl': [6, 13, 24, 36, 52],
    'single-leg-hip-thrust': [15, 28, 45, 65, 95],
    'single-leg-glute-bridge': [18, 32, 52, 75, 110],
    'frog-pump': [20, 38, 60, 90, 130],
    'donkey-kick': [15, 30, 50, 75, 110],
    ...
    'single-leg-calf-raise': [15, 28, 45, 65, 95],
    'tibialis-raise': [15, 30, 50, 75, 110],
    'reverse-crunch': [14, 26, 42, 60, 88],
    'decline-crunch': [14, 26, 42, 60, 88],
    'decline-sit-up': [13, 24, 40, 58, 82],
    'v-up': [8, 16, 28, 44, 66],
    'lying-leg-raise': [8, 16, 28, 44, 66],
    'ab-wheel-rollout': [1, 4, 10, 20, 34],
  };
}
